    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            Try
                ...
                Dim insertar = New OleDbCommand("INSERT INTO VEHICULO(placa, mt3, idCliente) VALUES(@placa, @mt3, @idCliente)", conexion)
                ...
                For Each row As DataGridViewRow In dgvVehiculo.Rows
                    ...
                    insertar.Parameters.AddWithValue("@placa", Convert.ToInt64(cboCliente.SelectedValue))
